      ...
      typography: ({ theme }) => ({
        DEFAULT: {
          css: {
            ...
            a: { color: theme('colors.primary.DEFAULT'), textDecoration: 'none', '&:hover': { textDecoration: 'underline' } },
            ...
            code: { color: theme('colors.foreground'), backgroundColor: theme('colors.muted.DEFAULT'), padding: '0.125rem 0.25rem', borderRadius: '0.25rem' },
          },
        },
        invert: {
          css: {
